...
- **[Sutton & Barto Textbook](http://incompleteideas.net/book/)** - Reinforcement Learning: An Introduction (Free online)
- **[Introduction to Reinforcement Learning](https://amfarahmand.github.io/IntroRL/)** by Amir-massoud Farahmand - A course on RL with emphasis on theoretical foundations
...
- **[OpenAI Spinning Up](https://spinningup.openai.com/)** - RL Resources and implementations
