...
| Lab | Due Date | Topic |
|-----|----------|-------|
| Lab 1 | Jan 20, 2026 | Tabular value-iteration agent on Gridworld |
| Lab 2 | Jan 27, 2026 | Compare MC and TD methods; Q-Learning with ε-greedy |
| Lab 3 | Feb 17, 2026 | Implement DQN in Gymnasium (CartPole or MountainCar) |
| Lab 4 | Mar 3, 2026 | Train PPO agent on Pendulum-v1 (dm_control) |
| Lab 5 | Mar 10, 2026 | Implement RND agent in MiniGrid or Maze2D |
| Lab 6 | Mar 17, 2026 | Train CNN encoder on Atari frames; visualize latent space |
| Lab 7 (optional) |  | LLM finetuning |
