...
description: Course website for CSC415H5S Introduction to Reinforcement Learning - Winter 2026
nav: false
toc: true
toc_sidebar: right
---
...
<div class="card mb-4">
  <div class="card-body">
    ...
    <p class="card-text">
      ...
      This course provides an introduction to reinforcement learning intelligence, which focuses on the study and design of agents 
      that interact with a complex, uncertain world to achieve a goal.
    </p>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="card mb-3">
      ...
      <div class="card-body">
        <p class="mb-2"><strong>Dr. Ameya Pore</strong><br>
        <a href="mailto:amey.pore@utoronto.ca">amey.pore@utoronto.ca</a></p>
        
        <p class="mb-0"><strong>Office Hours:</strong><br>
        Wednesday, 6:00 PM - 7:00 PM<br>
        <em>In Person: DH3110</em></p>
        
        <small class="text-muted">Please allow 24-48 hours for response during regular business hours. Include [CSC415] in the subject line.</small>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <em>4th year undergraduate</em></p>
          </div>
          <div class="col-md-6">
...
The course takes an information-processing approach to the concept of mind and briefly touches on perspectives from psychology, neuroscience, and philosophy.
...
The course draws inspiration from several excellent open-source courses:

- **UCL Course on Reinforcement Learning** by David Silver (DeepMind)
- **Stanford CS224R: Deep Reinforcement Learning** by Chelsea Finn
- **Berkeley Deep RL Course** (various instructors)
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>25%</td>
        <td>Mar 24, 2026</td>
        <td>Comprehensive research paper in conference format (e.g., ICML/ICRA style) detailing methodology, experimental setup, results, and discussion.</td>
      </tr>
      <tr>
      ...
      <table class="table table-sm">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Jan 14</td>
            <td>Monte Carlo & Temporal-Difference Learning</td>
            <td>MC prediction (first/every visit), TD(0), TD(λ), SARSA, on/off-policy learning</td>
          </tr>
          <tr>
            <td><strong>3</strong></td>
            <td>Jan 21</td>
            <td>Q-Learning</td>
            <td>Q-Learning algorithm, bias–variance trade-off, linear value approximation</td>
          </tr>
          <tr>
            <td><strong>4</strong></td>
            <td>Jan 28</td>
            <td>Function Approximation & DQN</td>
            <td>Deep Q-Networks (DQN), Policy-Gradient Theorem, REINFORCE with baseline</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Mar 28</td>
            <td>Safe and Robust Reinforcement Learning</td>
            <td>Safe MDPs, constraint optimization, Lyapunov-based safety, CPO, risk-sensitive criteria</td>
          </tr>
          <tr>
  ...
  <div class="col-md-6">
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <a href="/assets/pdf/csc415_project_guideline.pdf" class="btn btn-sm btn-primary" target="_blank">
  ...
  <div class="col-md-6">
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <a href="/assets/pdf/csc415_project_topics.pdf" class="btn btn-sm btn-success" target="_blank">
...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <a href="/assets/pdf/csc415_simulation_setup.pdf" class="btn btn-sm btn-info" target="_blank">
...
- [Sutton & Barto Textbook](http://incompleteideas.net/book/) (Free online)
- [David Silver's RL Course](http://www0.cs.ucl.ac.uk/staff/d.silver/web/Teaching.html) (UCL)
- [Stanford CS224R](https://cs224r.stanford.edu/) (Deep Reinforcement Learning)
- [OpenAI Spinning Up](https://spinningup.openai.com/) (RL Resources)
